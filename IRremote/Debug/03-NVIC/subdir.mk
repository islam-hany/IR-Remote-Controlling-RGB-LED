...
C_SRCS += \
E:/ARM/COTS/1-MCAL/03-NVIC/NVIC_program.c 

OBJS += \
./03-NVIC/NVIC_program.o 

C_DEPS += \
./03-NVIC/NVIC_program.d 


# Each subdirectory must supply rules for building sources it contributes
03-NVIC/NVIC_program.o: E:/ARM/COTS/1-MCAL/03-NVIC/NVIC_program.c 03-NVIC/subdir.mk
...
clean: clean-03-2d-NVIC

clean-03-2d-NVIC:
	-$(RM) ./03-NVIC/NVIC_program.cyclo ./03-NVIC/NVIC_program.d ./03-NVIC/NVIC_program.o ./03-NVIC/NVIC_program.su

.PHONY: clean-03-2d-NVIC
